        ...
        expect(result).toEqual(
          {
            count: 2,
            columns: [
              { name: 'firstname', maxCharWidthCount: 3, tpe: 'varchar' },
              { name: 'last_quote_name', maxCharWidthCount: 17, tpe: 'varchar' },
              { name: 'email', maxCharWidthCount: 29, tpe: 'varchar' }
            ],
            name: expect.any(String),
            sql,
            rows: [
              ['Har', 'Wat', 'Har"quote"someone@yopmail.com'],
              ['Joy', `something${format.separator}another`, 'another@yopmail.com']
            ]
          }
        )
      })
